...
const deepClone1 = function (obj, hash = new WeakMap()) {
  ...
  const allDesc = Object.getOwnPropertyDescriptors(obj); // 解决Object.assign()无法正确拷贝get属性和set属性的问题
  // 遍历传入参数所有键的特性
  const cloneObj = Object.create(Object.getPrototypeOf(obj), allDesc); // 原型上数据
  // 继承原型链
